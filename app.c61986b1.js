...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/@byungi/promise-helpers/index.js":[function(require,module,exports) {
"use strict";
...
function assert(name, expected, val) {
  ...
  if (type !== expected) {
    throw new TypeError("Expected \"".concat(name, "\" to be of type ").concat(expected, ", but \"").concat(type, "\"."));
  }
}
...
},{}],"../node_modules/@byungi/p-delay/index.js":[function(require,module,exports) {
"use strict";
...
var promise_helpers_1 = require("@byungi/promise-helpers");

exports.pDelay = function (ms) {
...
},{"@byungi/promise-helpers":"../node_modules/@byungi/promise-helpers/index.js"}],"../src/index.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Progress.prototype.promise = function (promise, delay) {
    ...
    if (delay > 0) {
      setTimeout(function () {
        if (_this._promises.indexOf(promise) > -1) {
          started = true;
...
var p_delay_1 = require("@byungi/p-delay");

var src_1 = require("../src/");

window.progress = new src_1.Progress({
  height: 5
});
window.delay = p_delay_1.pDelay;
},{"@byungi/p-delay":"../node_modules/@byungi/p-delay/index.js","../src/":"../src/index.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "6716" + '/');
